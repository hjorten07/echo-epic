...
export const ImposterLobby = ({ game }: Props) => {
  ...
  const hasEnoughPlayers = game.players.length >= 3;
    ...
    <div className="grid md:grid-cols-2 gap-6">
      ...
      <div className="glass-card p-6 rounded-2xl">
        ...
        {game.players.length < 3 && (
          <div className="mb-4 p-3 rounded-xl bg-yellow-500/10 text-yellow-600 text-sm">
            ⚠️ Minimum 3 players required to start
          </div>
        )}
